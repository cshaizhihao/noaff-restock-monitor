...
class InstallScriptTestCase(unittest.TestCase):
    ...
    def test_dashboard_polling_updates_task_cards_in_place(self) -> None:
        ...
        self.assertIn("data-task-status-dot", app_js)
        self.assertIn("statusDotClass(statusClass)", app_js)
    ...
    def test_dashboard_manual_and_webhook_controls_are_wired(self) -> None:
        ...
        self.assertIn('value="auto"', portal_html)
        self.assertIn('value="standard"', portal_html)
        self.assertIn('value="dynamic"', portal_html)
        self.assertIn('value="compatible"', portal_html)
        self.assertIn('value="external_solver"', portal_html)
        ...
        self.assertIn('value="auto"', task_strategy_block)
        self.assertIn('value="standard"', task_strategy_block)
        self.assertIn('value="dynamic"', task_strategy_block)
        self.assertIn('value="compatible"', task_strategy_block)
        self.assertIn('value="external_solver"', task_strategy_block)
        self.assertIn('value="manual"', task_strategy_block)
        self.assertIn('value="webhook"', task_strategy_block)
        self.assertNotIn('value="multi_engine"', task_strategy_block)
        self.assertNotIn('value="curl_cffi"', task_strategy_block)
        self.assertNotIn('value="scrapling_standard"', task_strategy_block)
        self.assertNotIn('value="scrapling_dynamic"', task_strategy_block)
        self.assertNotIn('value="scrapling_stealth"', task_strategy_block)
        self.assertNotIn('value="adaptive"', task_strategy_block)
        self.assertNotIn('value="generic_pricing_table"', task_strategy_block)
        self.assertNotIn('value="whmcs"', task_strategy_block)
        ...
        self.assertIn('data-task-strategy-card="auto"', portal_html)
        self.assertIn('data-task-strategy-card="standard"', portal_html)
        self.assertIn('data-task-strategy-card="dynamic"', portal_html)
        self.assertIn('data-task-strategy-card="compatible"', portal_html)
        self.assertIn('data-task-strategy-card="external_solver"', portal_html)
        self.assertIn('data-task-strategy-card="manual"', portal_html)
        self.assertIn('data-task-strategy-card="webhook"', portal_html)
        ...
        self.assertIn('id="task-rule-preset-grid"', portal_html)
        self.assertIn('id="task-rule-preset-summary"', portal_html)
        self.assertIn('data-task-rule-preset="auto"', portal_html)
        self.assertIn('data-task-rule-preset="idc_card"', portal_html)
        self.assertIn('data-task-rule-preset="css_buttons"', portal_html)
        self.assertIn('data-task-rule-preset="css_stock"', portal_html)
        self.assertIn('data-task-rule-preset="regex"', portal_html)
        ...
        self.assertIn('id="task-soldout-selector"', portal_html)
        self.assertIn('id="task-button-selector"', portal_html)
        self.assertIn('id="task-disabled-selector"', portal_html)
        self.assertIn('id="task-regex-pattern"', portal_html)
        ...
        self.assertIn('id="task-strategy-recommendation"', portal_html)
        ...
        self.assertIn('class="task-wizard-form"', portal_html)
        self.assertIn('data-task-step-target="basic"', portal_html)
        self.assertIn('data-task-step-target="strategy"', portal_html)
        self.assertIn('data-task-step-target="rules"', portal_html)
        self.assertIn('data-task-step-target="notify"', portal_html)
        self.assertIn('data-task-step-panel="basic"', portal_html)
        self.assertIn('data-task-step-panel="strategy"', portal_html)
        self.assertIn('data-task-step-panel="rules"', portal_html)
        self.assertIn('data-task-step-panel="notify"', portal_html)
        self.assertIn('id="task-step-prev-button"', portal_html)
        ...
        self.assertIn("function normalizeTaskFetchMode", app_js)
        self.assertIn("function fetchStrategyForMode", app_js)
        self.assertIn("自动模式：系统优先用低成本采集", app_js)
        self.assertIn("标准模式：不启动浏览器", app_js)
        self.assertIn("高兼容模式：适合复杂页面", app_js)
        self.assertIn('return "multi_engine";', app_js)
        self.assertIn("fetch_mode: normalizeTaskFetchMode", app_js)
        self.assertIn("fetch_strategy: fetchStrategyForMode", app_js)
        self.assertIn("function updateTaskStrategyUi", app_js)
        self.assertIn("function recommendedStrategyForUrl", app_js)
        self.assertIn("DMIT 购物车页", app_js)
        self.assertIn("data-task-site-profile", app_js)
        self.assertIn("site-profile-chip", app_js)
        self.assertIn("function setTaskStrategy", app_js)
        self.assertIn("function setTaskFormStep", app_js)
        self.assertIn("function requestTaskFormStep", app_js)
        self.assertIn("function validateTaskStep", app_js)
        self.assertIn("function updateTaskWizardSummary", app_js)
        self.assertIn("function moveTaskFormStep", app_js)
        self.assertIn("data-task-step-target", app_js)
        self.assertIn("data-task-step-prev", app_js)
        self.assertIn("data-task-step-next", app_js)
        self.assertIn("function setTaskRuleFields", app_js)
        self.assertIn("function collectTaskSourceConfig", app_js)
        self.assertIn("stock_rule_type", app_js)
        self.assertIn("target_scope_selector", app_js)
        self.assertIn("const taskRulePresets", app_js)
        self.assertIn("function inferTaskRulePreset", app_js)
        self.assertIn("function applyTaskRulePreset", app_js)
        self.assertIn("button_selector", app_js)
        self.assertIn("disabled_selector", app_js)
        self.assertIn("source_config: collectTaskSourceConfig()", app_js)
        self.assertIn("[data-task-strategy-card]", app_js)
        self.assertIn("[data-task-rule-preset]", app_js)
        self.assertIn("只有 Webhook 任务才会显示 Token 重置操作", app_js)
        self.assertIn("els.taskFetchStrategy?.addEventListener(\"change\", () =>", app_js)
        self.assertIn("updateTaskWizardSummary();", app_js)
        ...
        self.assertIn('if (normalizedStrategy === "webhook")', app_js)
        self.assertNotIn('normalizedStrategy === "webhook" ? "" : "hidden"', app_js)
        self.assertIn("data-task-check-action", app_js)
        self.assertIn('data-action="check"', app_js)
        self.assertIn(".task-rule-preset-grid", app_css)
        self.assertIn(".task-rule-preset.is-active", app_css)
        self.assertIn(".task-rule-preset-summary", app_css)
        self.assertIn(".task-strategy-recommendation", app_css)
        self.assertIn(".site-profile-chip", app_css)
    ...
    def test_release_notes_capture_protected_source_boundary(self) -> None:
        ...
        self.assertIn("Firecrawl external fallback", release_notes)
        self.assertIn("Firecrawl diagnostics", release_notes)
        ...
        self.assertIn("CATALOG_SCRAPE_STRATEGY=multi_engine", release_notes)
    ...
    def test_env_example_documents_firecrawl_and_catalog_defaults(self) -> None:
        ...
        self.assertIn("SCRAPLING_ENABLED=true", env_example)
        self.assertIn("SCRAPLING_DEFAULT_MODE=standard", env_example)
        self.assertIn("SCRAPLING_USE_FOR_MONITOR=true", env_example)
        self.assertIn("SCRAPLING_USE_FOR_CATALOG=true", env_example)
        self.assertIn("SCRAPLING_TIMEOUT_STANDARD=25", env_example)
        self.assertIn("SCRAPLING_TIMEOUT_DYNAMIC=45", env_example)
        self.assertIn("SCRAPLING_TIMEOUT_STEALTH=75", env_example)
        self.assertIn("SCRAPLING_MAX_CONCURRENCY_STEALTH=1", env_example)
        ...
        self.assertIn("curl_cffi>=0.7,<1", requirements)
        script = (ROOT_DIR / "install.sh").read_text(encoding="utf-8")
        dockerfile = (ROOT_DIR / "Dockerfile").read_text(encoding="utf-8")
        self.assertIn("verify_scrapling_runtime", script)
        self.assertIn('run_step "验证 Scrapling 采集引擎" verify_scrapling_runtime', script)
        self.assertIn('run_step "准备 Scrapling 浏览器运行时" ensure_scrapling_browser_runtime', script)
        self.assertIn("ensure_scrapling_browser_runtime()", script)
        self.assertIn("patchright install chromium", script)
        self.assertIn("playwright install chromium", script)
        self.assertIn("Scrapling 采集引擎依赖检测通过，浏览器", script)
        self.assertIn("Scrapling 采集引擎依赖检测失败", script)
        self.assertIn("Scrapling 浏览器检测失败", script)
        ...
        self.assertIn("CATALOG_SCRAPE_STRATEGY=multi_engine", env_example)
        self.assertIn("CATALOG_DEFAULT_FETCH_STRATEGY=multi_engine", env_example)
    ...
    def test_dashboard_polling_does_not_replay_task_reveal_animation(self) -> None:
        ...
        self.assertIn('const rowClass = animateCards ? "task-row task-product-card reveal" : "task-row task-product-card"', app_js)
    ...
    def test_dashboard_supports_hierarchical_sortable_task_cards(self) -> None:
        ...
        self.assertIn('data-group-action="bulk-move"', app_js)
        ...
        self.assertIn("data-task-move-action", app_js)
        ...
        self.assertIn("function openTaskMoveModal", app_js)
        self.assertIn("function submitTaskMove", app_js)
        self.assertIn("function updateTaskMovePreview", app_js)
        self.assertIn("formatTaskMoveDestination", app_js)
        self.assertIn("function taskMoveDestinationCandidates", app_js)
        self.assertIn("function renderTaskMoveDestinations", app_js)
        self.assertIn("function chooseTaskMoveDestination", app_js)
        self.assertIn("data-move-destination-group", app_js)
        self.assertIn("function bulkMoveSelectedTasks", app_js)
        self.assertIn("/api/tasks/move", app_js)
        ...
        self.assertIn(".task-wizard-summary", app_css)
        ...
        self.assertIn('id="task-move-modal"', portal_html)
        self.assertIn('id="task-move-group"', portal_html)
        self.assertIn('id="task-move-group-custom"', portal_html)
        self.assertIn('id="task-move-subgroup"', portal_html)
        self.assertIn('id="task-move-subgroup-custom"', portal_html)
        self.assertIn('id="task-move-source"', portal_html)
        self.assertIn('id="task-move-target"', portal_html)
        self.assertIn('id="task-move-destinations"', portal_html)
        self.assertIn('id="task-move-preview"', portal_html)
        self.assertIn(".task-move-summary-grid", app_css)
        self.assertIn(".task-move-destination-grid", app_css)
        self.assertIn(".task-move-destination.is-active", app_css)
        self.assertIn(".task-move-preview", app_css)
    ...
    def test_settings_ui_splits_product_intake_and_firecrawl_integration(self) -> None:
        ...
        self.assertIn("Scrapling 采集引擎", portal_html)
        self.assertIn('data-settings-target="settings-scrapling"', portal_html)
        self.assertIn('id="settings-scrapling-enabled"', portal_html)
        self.assertIn('id="settings-scrapling-default-mode"', portal_html)
        self.assertIn('id="settings-scrapling-status"', portal_html)
        self.assertIn('id="settings-scrapling-status-pill"', portal_html)
        ...
        self.assertIn('settingsScraplingTestButton: document.getElementById("settings-scrapling-test-button")', app_js)
        self.assertIn('settingsScraplingEnabled: document.getElementById("settings-scrapling-enabled")', app_js)
        self.assertIn('settingsScraplingDefaultMode: document.getElementById("settings-scrapling-default-mode")', app_js)
        self.assertIn("settings.scrapling_status", app_js)
        self.assertIn("function renderScraplingRuntimeStatus", app_js)
        ...
        self.assertIn("candidate_urls", app_js)
        self.assertIn("setup_hint", app_js)
        ...
        self.assertIn(".settings-scrapling-grid", app_css)
        self.assertIn(".scrapling-status-box", app_css)
        self.assertIn(".scrapling-status-actions", app_css)
        self.assertIn(".settings-advanced-block", app_css)
        ...
        self.assertIn('data-settings-target="settings-engine-runtime"', portal_html)
        ...
        self.assertIn('id="domain-session-import-json"', portal_html)
        self.assertIn('id="domain-session-copy-script"', portal_html)
        self.assertIn('id="domain-session-script-preview"', portal_html)
        self.assertIn("function domainSessionConsoleScript", app_js)
        self.assertIn("copyDomainSessionConsoleScript", app_js)
        self.assertIn("domainSessionImportJson", app_js)
        self.assertIn(".domain-session-console-header", app_css)
        self.assertIn(".ghost-button.compact", app_css)
        ...
        self.assertEqual(portal_html.count("settings-entry-top"), 4)
        self.assertEqual(portal_html.count("settings-entry-bottom"), 3)
        self.assertIn("grid-template-columns: repeat(4", app_css)
        self.assertNotIn('data-settings-target="settings-browser-runtime"', portal_html)
        self.assertIn("兼容旧采集链路", portal_html)
        settings_home = portal_html.split('id="settings-home"', 1)[1].split('id="settings-pages"', 1)[0]
        self.assertNotIn("升级与维护", settings_home)
        self.assertNotIn("旧链路兼容", settings_home)
        self.assertNotIn("浏览器运行时", settings_home)
        self.assertNotIn("Chromium", settings_home)
        self.assertNotIn("端口", settings_home)
    ...
    def test_dashboard_uses_card_grid_instead_of_waterfall_rows(self) -> None:
        app_js = (ROOT_DIR / "static" / "app.js").read_text(encoding="utf-8")
        app_css = (ROOT_DIR / "static" / "app.css").read_text(encoding="utf-8")
        portal_html = (ROOT_DIR / "templates" / "portal.html").read_text(encoding="utf-8")
        ...
        self.assertIn("grid-template-columns: repeat(auto-fill, minmax(19.5rem, 22.25rem));", app_css)
        self.assertIn("justify-content: start;", app_css)
        self.assertIn("width: 100%;", app_css)
        self.assertIn("max-width: 22.25rem;", app_css)
        ...
        self.assertIn("min-height: 3.1rem;", app_css)
        self.assertIn("max-height: 6.6rem;", app_css)
        self.assertIn("max-height: 2.65rem;", app_css)
        self.assertIn("max-height: none;", app_css)
        ...
        self.assertIn(".sortable-ghost", app_css)
        ...
        self.assertIn("task-session-actions", app_js)
        self.assertIn(".task-session-actions", app_css)
        self.assertIn("初始化", app_js)
        self.assertIn("导入", app_js)
        ...
        self.assertIn("align-items: stretch;", app_css)
        self.assertNotIn("grid-template-columns: minmax(15rem, 1.35fr)", app_css)
        self.assertNotIn("grid-auto-rows: min-content;", app_css)
        self.assertIn("intake-results-stack", portal_html)
        self.assertNotIn("立即检测库存", app_js)
        self.assertNotIn("min-height: min(64vh", app_css)
        self.assertNotIn("min-height: 9.5rem", app_css)
        self.assertNotIn("max-height: min(58vh", app_css)
        ...
        self.assertNotIn('class="task-card"', app_js)
    ...
    def test_product_intake_workbench_exposes_round7_controls(self) -> None:
        ...
        self.assertIn(".merchant-wizard-summary", (ROOT_DIR / "static" / "app.css").read_text(encoding="utf-8"))
        ...
        self.assertIn("function requestMerchantStep", app_js)
        self.assertIn("function validateMerchantStep", app_js)
        self.assertIn("function updateMerchantWizardSummary", app_js)
        ...
        self.assertIn('value="local"', discovery_block)
        self.assertNotIn('value="firecrawl_map"', discovery_block)
        self.assertNotIn('value="hybrid"', discovery_block)
        self.assertIn('value="multi_engine"', scrape_block)
        self.assertIn('value="curl_cffi"', scrape_block)
        self.assertIn('value="scrapling_standard"', scrape_block)
        self.assertIn('value="scrapling_dynamic"', scrape_block)
        self.assertIn('value="scrapling_stealth"', scrape_block)
        self.assertNotIn('value="browser"', scrape_block)
        self.assertNotIn('value="static_http"', scrape_block)
        self.assertNotIn('value="firecrawl"', scrape_block)
        self.assertIn('value="multi_engine"', task_strategy_block)
        self.assertIn('value="curl_cffi"', task_strategy_block)
        self.assertNotIn('value="browser"', task_strategy_block)
        self.assertNotIn('value="static_http"', task_strategy_block)
        self.assertNotIn('value="firecrawl"', task_strategy_block)
        ...
        self.assertIn('resetSelectIfDisabled(els.merchantScrapeStrategy, "multi_engine")', app_js)
        self.assertIn('resetSelectIfDisabled(els.merchantDefaultFetchStrategy, "multi_engine")', app_js)

...
class InstallScriptTestCase(unittest.TestCase):
    ...
    def test_dashboard_manual_and_webhook_controls_are_wired(self) -> None:
        ...
        self.assertIn('value="scrapling_standard"', portal_html)
        self.assertIn('value="scrapling_dynamic"', portal_html)
        self.assertIn('value="scrapling_stealth"', portal_html)
        self.assertIn('value="scrapling_adaptive"', portal_html)
        ...
        self.assertIn('value="scrapling_adaptive"', task_strategy_block)
        ...
        self.assertIn("Scrapling 自适应（推荐）", task_strategy_block)
        self.assertIn('id="task-strategy-cards"', portal_html)
        self.assertIn('data-task-strategy-card="scrapling_adaptive"', portal_html)
        self.assertIn('data-task-strategy-card="scrapling_dynamic"', portal_html)
        self.assertIn('data-task-strategy-card="scrapling_stealth"', portal_html)
        ...
        self.assertIn("默认使用 Scrapling 自适应采集", portal_html)
        ...
        self.assertIn('return "scrapling_adaptive";', app_js)
        self.assertIn("新任务建议使用 Scrapling 自适应", app_js)
    ...
    def test_release_notes_capture_protected_source_boundary(self) -> None:
        ...
        self.assertIn("Scrapling-first", release_notes)
        self.assertIn("scrapling_adaptive", release_notes)
        ...
        self.assertIn("CATALOG_SCRAPE_STRATEGY=scrapling_adaptive", release_notes)
    ...
    def test_dashboard_uses_card_grid_instead_of_waterfall_rows(self) -> None:
        ...
        self.assertIn("grid-template-columns: repeat(auto-fill, minmax(min(100%, 20rem), 1fr));", app_css)
        self.assertIn("justify-content: stretch;", app_css)
        self.assertIn("width: 100%;", app_css)
        self.assertIn("max-height: none;", app_css)
        self.assertIn("overflow: visible;", app_css)
        self.assertNotIn("grid-template-columns: repeat(auto-fill, minmax(19.75rem, 21.25rem));", app_css)
        ...
        self.assertIn("min-height: 3.95rem;", app_css)
        self.assertIn("max-height: none;", app_css)
    ...
    def test_product_intake_workbench_exposes_round7_controls(self) -> None:
        ...
        self.assertIn('value="scrapling_adaptive"', scrape_block)
        ...
        self.assertIn('resetSelectIfDisabled(els.merchantScrapeStrategy, "scrapling_adaptive")', app_js)
        self.assertIn('resetSelectIfDisabled(els.merchantDefaultFetchStrategy, "scrapling_adaptive")', app_js)

...
class InstallScriptTestCase(unittest.TestCase):
    ...
    def test_dashboard_manual_and_webhook_controls_are_wired(self) -> None:
        ...
        self.assertLess(task_strategy_block.index('value="scrapling_adaptive"'), task_strategy_block.index('value="adaptive"'))
        self.assertLess(task_strategy_block.index('value="scrapling_adaptive"'), task_strategy_block.index('value="firecrawl"'))
        ...
        self.assertIn("旧版自适应低成本", task_strategy_block)
        ...
        self.assertIn('data-task-strategy-card="firecrawl"', portal_html)
        self.assertIn("外部兜底 / 旧版采集方式", portal_html)
        ...
        self.assertIn("Scrapling 标准模式", app_js)
        self.assertIn("Scrapling 高兼容模式", app_js)
    ...
    def test_settings_ui_splits_product_intake_and_firecrawl_integration(self) -> None:
        ...
        self.assertIn("Firecrawl 外部兜底", portal_html)
    ...
    def test_dashboard_uses_card_grid_instead_of_waterfall_rows(self) -> None:
        ...
        self.assertIn("grid-template-columns: repeat(auto-fill, minmax(19.75rem, 21.25rem));", app_css)
        self.assertIn("width: min(100%, 21.25rem);", app_css)
        self.assertIn("justify-content: start;", app_css)
        self.assertIn("scrollbar-gutter: stable both-edges;", app_css)
        ...
        self.assertIn("height: 3.05rem;", app_css)
        ...
        self.assertIn("@container (max-width: 22rem)", app_css)

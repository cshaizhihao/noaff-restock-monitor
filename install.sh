...
CATALOG_DEBUG_PORT="${CATALOG_DEBUG_PORT:-9445}"
POLL_INTERVAL_SECONDS="${POLL_INTERVAL_SECONDS:-90}"
...
FIRECRAWL_TIMEOUT_SECONDS="${FIRECRAWL_TIMEOUT_SECONDS:-60}"
FIRECRAWL_MAX_AGE_MS="${FIRECRAWL_MAX_AGE_MS:-0}"
FIRECRAWL_STORE_IN_CACHE="${FIRECRAWL_STORE_IN_CACHE:-false}"
FIRECRAWL_PROXY_MODE="${FIRECRAWL_PROXY_MODE:-basic}"
FIRECRAWL_ALLOW_AUTO_PROXY="${FIRECRAWL_ALLOW_AUTO_PROXY:-false}"
FIRECRAWL_ALLOW_ENHANCED_PROXY="${FIRECRAWL_ALLOW_ENHANCED_PROXY:-false}"
FIRECRAWL_ZERO_DATA_RETENTION="${FIRECRAWL_ZERO_DATA_RETENTION:-false}"
FIRECRAWL_USE_FOR_MONITOR="${FIRECRAWL_USE_FOR_MONITOR:-false}"
FIRECRAWL_USE_FOR_CATALOG="${FIRECRAWL_USE_FOR_CATALOG:-true}"
FIRECRAWL_CATALOG_LIMIT="${FIRECRAWL_CATALOG_LIMIT:-50}"

ENHANCED_COLLECTOR_ENABLED="${ENHANCED_COLLECTOR_ENABLED:-false}"
ENHANCED_COLLECTOR_API_URL="${ENHANCED_COLLECTOR_API_URL:-}"
ENHANCED_COLLECTOR_TIMEOUT_SECONDS="${ENHANCED_COLLECTOR_TIMEOUT_SECONDS:-90}"
ENHANCED_COLLECTOR_MAX_RETRIES="${ENHANCED_COLLECTOR_MAX_RETRIES:-1}"
ENHANCED_COLLECTOR_USE_FOR_MONITOR="${ENHANCED_COLLECTOR_USE_FOR_MONITOR:-false}"
ENHANCED_COLLECTOR_USE_FOR_CATALOG="${ENHANCED_COLLECTOR_USE_FOR_CATALOG:-true}"

SCRAPLING_ENABLED="${SCRAPLING_ENABLED:-true}"
SCRAPLING_DEFAULT_MODE="${SCRAPLING_DEFAULT_MODE:-standard}"
SCRAPLING_USE_FOR_MONITOR="${SCRAPLING_USE_FOR_MONITOR:-true}"
SCRAPLING_USE_FOR_CATALOG="${SCRAPLING_USE_FOR_CATALOG:-true}"
SCRAPLING_TIMEOUT_STANDARD="${SCRAPLING_TIMEOUT_STANDARD:-25}"
SCRAPLING_TIMEOUT_DYNAMIC="${SCRAPLING_TIMEOUT_DYNAMIC:-45}"
SCRAPLING_TIMEOUT_STEALTH="${SCRAPLING_TIMEOUT_STEALTH:-75}"
SCRAPLING_DOMAIN_COOLDOWN_STANDARD="${SCRAPLING_DOMAIN_COOLDOWN_STANDARD:-0}"
SCRAPLING_DOMAIN_COOLDOWN_DYNAMIC="${SCRAPLING_DOMAIN_COOLDOWN_DYNAMIC:-60}"
SCRAPLING_DOMAIN_COOLDOWN_STEALTH="${SCRAPLING_DOMAIN_COOLDOWN_STEALTH:-300}"
SCRAPLING_MAX_CONCURRENCY_STANDARD="${SCRAPLING_MAX_CONCURRENCY_STANDARD:-3}"
SCRAPLING_MAX_CONCURRENCY_DYNAMIC="${SCRAPLING_MAX_CONCURRENCY_DYNAMIC:-2}"
SCRAPLING_MAX_CONCURRENCY_STEALTH="${SCRAPLING_MAX_CONCURRENCY_STEALTH:-1}"
SCRAPLING_SESSION_REUSE="${SCRAPLING_SESSION_REUSE:-true}"
SCRAPLING_ADAPTIVE_SELECTOR="${SCRAPLING_ADAPTIVE_SELECTOR:-true}"
SCRAPLING_HEADLESS="${SCRAPLING_HEADLESS:-true}"
...
load_existing_env_defaults() {
  ...
  prefer_existing_value "CATALOG_DEBUG_PORT" "9445"
  prefer_existing_value "POLL_INTERVAL_SECONDS" "90"
  prefer_existing_value "REQUEST_TIMEOUT_SECONDS" "25"
  prefer_existing_value "FIRECRAWL_ENABLED" "false"
  prefer_existing_value "FIRECRAWL_API_URL" "https://api.firecrawl.dev"
  prefer_existing_value "FIRECRAWL_TIMEOUT_SECONDS" "60"
  prefer_existing_value "FIRECRAWL_MAX_AGE_MS" "0"
  prefer_existing_value "FIRECRAWL_STORE_IN_CACHE" "false"
  prefer_existing_value "FIRECRAWL_PROXY_MODE" "basic"
  prefer_existing_value "FIRECRAWL_ALLOW_AUTO_PROXY" "false"
  prefer_existing_value "FIRECRAWL_ALLOW_ENHANCED_PROXY" "false"
  prefer_existing_value "FIRECRAWL_ZERO_DATA_RETENTION" "false"
  prefer_existing_value "FIRECRAWL_USE_FOR_MONITOR" "false"
  prefer_existing_value "FIRECRAWL_USE_FOR_CATALOG" "true"
  prefer_existing_value "FIRECRAWL_CATALOG_LIMIT" "50"
  prefer_existing_value "ENHANCED_COLLECTOR_ENABLED" "false"
  prefer_existing_value "ENHANCED_COLLECTOR_API_URL" ""
  prefer_existing_value "ENHANCED_COLLECTOR_TIMEOUT_SECONDS" "90"
  prefer_existing_value "ENHANCED_COLLECTOR_MAX_RETRIES" "1"
  prefer_existing_value "ENHANCED_COLLECTOR_USE_FOR_MONITOR" "false"
  prefer_existing_value "ENHANCED_COLLECTOR_USE_FOR_CATALOG" "true"
  prefer_existing_value "SCRAPLING_ENABLED" "true"
  prefer_existing_value "SCRAPLING_DEFAULT_MODE" "standard"
  prefer_existing_value "SCRAPLING_USE_FOR_MONITOR" "true"
  prefer_existing_value "SCRAPLING_USE_FOR_CATALOG" "true"
  prefer_existing_value "SCRAPLING_TIMEOUT_STANDARD" "25"
  prefer_existing_value "SCRAPLING_TIMEOUT_DYNAMIC" "45"
  prefer_existing_value "SCRAPLING_TIMEOUT_STEALTH" "75"
  prefer_existing_value "SCRAPLING_DOMAIN_COOLDOWN_STANDARD" "0"
  prefer_existing_value "SCRAPLING_DOMAIN_COOLDOWN_DYNAMIC" "60"
  prefer_existing_value "SCRAPLING_DOMAIN_COOLDOWN_STEALTH" "300"
  prefer_existing_value "SCRAPLING_MAX_CONCURRENCY_STANDARD" "3"
  prefer_existing_value "SCRAPLING_MAX_CONCURRENCY_DYNAMIC" "2"
  prefer_existing_value "SCRAPLING_MAX_CONCURRENCY_STEALTH" "1"
  prefer_existing_value "SCRAPLING_SESSION_REUSE" "true"
  prefer_existing_value "SCRAPLING_ADAPTIVE_SELECTOR" "true"
  prefer_existing_value "SCRAPLING_HEADLESS" "true"
  ...
  [[ -n "$FIRECRAWL_API_KEY" ]] || FIRECRAWL_API_KEY="$(read_env_value "FIRECRAWL_API_KEY")"
...
validate_runtime_config() {
  ...
  validate_port "CATALOG_DEBUG_PORT" "$CATALOG_DEBUG_PORT" 1024 65535
  validate_port "FIRECRAWL_TIMEOUT_SECONDS" "$FIRECRAWL_TIMEOUT_SECONDS" 10 180
  validate_port "FIRECRAWL_MAX_AGE_MS" "$FIRECRAWL_MAX_AGE_MS" 0 604800000
  validate_port "FIRECRAWL_CATALOG_LIMIT" "$FIRECRAWL_CATALOG_LIMIT" 1 250
  validate_port "ENHANCED_COLLECTOR_TIMEOUT_SECONDS" "$ENHANCED_COLLECTOR_TIMEOUT_SECONDS" 5 180
  validate_port "ENHANCED_COLLECTOR_MAX_RETRIES" "$ENHANCED_COLLECTOR_MAX_RETRIES" 0 5
  validate_port "SCRAPLING_TIMEOUT_STANDARD" "$SCRAPLING_TIMEOUT_STANDARD" 5 180
  validate_port "SCRAPLING_TIMEOUT_DYNAMIC" "$SCRAPLING_TIMEOUT_DYNAMIC" 10 240
  validate_port "SCRAPLING_TIMEOUT_STEALTH" "$SCRAPLING_TIMEOUT_STEALTH" 15 300

  [[ "$MONITOR_DEBUG_PORT" != "$TEST_DEBUG_PORT" ]] || die "MONITOR_DEBUG_PORT and TEST_DEBUG_PORT must be different."
  [[ "$MONITOR_DEBUG_PORT" != "$CATALOG_DEBUG_PORT" ]] || die "MONITOR_DEBUG_PORT and CATALOG_DEBUG_PORT must be different."
  [[ "$TEST_DEBUG_PORT" != "$CATALOG_DEBUG_PORT" ]] || die "TEST_DEBUG_PORT and CATALOG_DEBUG_PORT must be different."
  ...
  [[ "$CATALOG_DEBUG_PORT" != "$APP_PORT" ]] || die "CATALOG_DEBUG_PORT must not reuse APP_PORT."
...
print_validation_summary() {
  ...
  echo "MONITOR/TEST/CAT CDP: ${MONITOR_DEBUG_PORT}/${TEST_DEBUG_PORT}/${CATALOG_DEBUG_PORT}"
  echo "SCRAPLING:         ${SCRAPLING_ENABLED} mode=${SCRAPLING_DEFAULT_MODE}"
  echo "ENHANCED_COLLECTOR:${ENHANCED_COLLECTOR_ENABLED} ${ENHANCED_COLLECTOR_API_URL:-not configured}"
}
...
CATALOG_DEBUG_PORT=${CATALOG_DEBUG_PORT}
...
FIRECRAWL_MAX_AGE_MS=${FIRECRAWL_MAX_AGE_MS}
...
FIRECRAWL_USE_FOR_MONITOR=${FIRECRAWL_USE_FOR_MONITOR}
FIRECRAWL_USE_FOR_CATALOG=${FIRECRAWL_USE_FOR_CATALOG}
FIRECRAWL_CATALOG_LIMIT=${FIRECRAWL_CATALOG_LIMIT}
ENHANCED_COLLECTOR_ENABLED=${ENHANCED_COLLECTOR_ENABLED}
ENHANCED_COLLECTOR_API_URL=${ENHANCED_COLLECTOR_API_URL}
ENHANCED_COLLECTOR_TIMEOUT_SECONDS=${ENHANCED_COLLECTOR_TIMEOUT_SECONDS}
ENHANCED_COLLECTOR_MAX_RETRIES=${ENHANCED_COLLECTOR_MAX_RETRIES}
ENHANCED_COLLECTOR_USE_FOR_MONITOR=${ENHANCED_COLLECTOR_USE_FOR_MONITOR}
ENHANCED_COLLECTOR_USE_FOR_CATALOG=${ENHANCED_COLLECTOR_USE_FOR_CATALOG}
SCRAPLING_ENABLED=${SCRAPLING_ENABLED}
SCRAPLING_DEFAULT_MODE=${SCRAPLING_DEFAULT_MODE}
SCRAPLING_USE_FOR_MONITOR=${SCRAPLING_USE_FOR_MONITOR}
SCRAPLING_USE_FOR_CATALOG=${SCRAPLING_USE_FOR_CATALOG}
SCRAPLING_TIMEOUT_STANDARD=${SCRAPLING_TIMEOUT_STANDARD}
SCRAPLING_TIMEOUT_DYNAMIC=${SCRAPLING_TIMEOUT_DYNAMIC}
SCRAPLING_TIMEOUT_STEALTH=${SCRAPLING_TIMEOUT_STEALTH}
SCRAPLING_DOMAIN_COOLDOWN_STANDARD=${SCRAPLING_DOMAIN_COOLDOWN_STANDARD}
SCRAPLING_DOMAIN_COOLDOWN_DYNAMIC=${SCRAPLING_DOMAIN_COOLDOWN_DYNAMIC}
SCRAPLING_DOMAIN_COOLDOWN_STEALTH=${SCRAPLING_DOMAIN_COOLDOWN_STEALTH}
SCRAPLING_MAX_CONCURRENCY_STANDARD=${SCRAPLING_MAX_CONCURRENCY_STANDARD}
SCRAPLING_MAX_CONCURRENCY_DYNAMIC=${SCRAPLING_MAX_CONCURRENCY_DYNAMIC}
SCRAPLING_MAX_CONCURRENCY_STEALTH=${SCRAPLING_MAX_CONCURRENCY_STEALTH}
SCRAPLING_SESSION_REUSE=${SCRAPLING_SESSION_REUSE}
SCRAPLING_ADAPTIVE_SELECTOR=${SCRAPLING_ADAPTIVE_SELECTOR}
